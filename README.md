...
* 我的博客地址: [凌烟的博客](http://blog.fangkang.xyz)
...
![](https://fang-kang.gitee.io/blog-img/blog.png)
...
// project config
export const HEADER_BLOG_NAME = '凌烟的博客' // header title 显示的名字
...
export const SIDEBAR = {
  ...
  // 个人主页
  homepages: {
    github: 'https://github.com/fang-kang',
  },
}
...
const config = {
  PORT: 6060, // 启动端口
  ADMIN_GITHUB_LOGIN_NAME: 'fang-kang', // 博主的 github 登录的账户名 user
  GITHUB: {
  ...
  EMAIL_NOTICE: {
    ...
    transporterConfig: {
      ...
      auth: {
        user: '1793980864@qq.com', // generated ethereal user
        pass: '123456', // generated ethereal password 授权码 而非 密码
      },
    },
    subject: '凌烟的博客 - 您的评论获得新的回复！', // 主题
    text: '您的评论获得新的回复！',
    WEB_HOST: 'http://8.130.31.13:1105/', // email callback url
  },
  TOKEN: {
